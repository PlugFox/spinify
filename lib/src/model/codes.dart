...
extension type const SpinifyDisconnectCode(int code) implements int {
  ...
  static ({int code, String reason, bool reconnect}) normalize(
      ...
      switch (code ?? 1) {
        ...
        /// for some reason and whants it to reconnect.
        3011 => (
            code: 3011,
        ...
        /// connection due to no pong received to application-level
        /// server-to-client pings in a configured time.
        3012 => (
            code: 3012,
        ...
        /// Custom disconnect codes from server. Reconnect is true by default.
        <= 3499 => (
            code: code ?? 0,
            reason: reason ?? 'transport closed',
            reconnect: true,
        ...
        /// DisconnectChannelLimit can be issued when client connection exceeds
        /// a configured channel limit.
        3505 => (
            code: 3505,
        ...
        /// DisconnectInappropriateProtocol can be issued when client connection
        /// format can not handle incoming data.
        ...
        /// DisconnectNotAvailable may be issued when ErrorNotAvailable does not
        /// fit message type, for example we issue DisconnectNotAvailable
